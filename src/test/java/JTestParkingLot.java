...
public class JTestParkingLot {
    ...
    public void getfiltercarListbasedOnRegNum()
    {
	 ...
	 @Test
    public void getfiltercarListbasedOnSlotNum()
    {
    	System.out.println("---- TDD getfiltercarListbasedOnSlotNum Stated---------");
    	ParkingLot w_ParkingLot = new ParkingLot(3);
    	...
    	ArrayList<Car> w_filteredCarList = w_ParkingLot.getFilterCarList("slot", "2");
